...
- `[TODO]` **Koło Fortuny:** Tymczasowo zrezygnowaliśmy, do przywrócenia w przyszłości.
- `[TODO]` **Historia WRSSu:** Fajna oś czasu ze zdjęciami starych składów.
- `[TODO]` **"Dziś jest środa":** Easter-egg działający tylko we środy.
- `[TODO]` **Licznik odwiedzin / Samorządowiec Miesiąca:** Dodatki integracyjne.
