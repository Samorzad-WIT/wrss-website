      ...
      <div className="footer-grid">
        ...
        <div className="footer-social-section">
          ...
          <div className="social-icons">
            <a
              href="https://www.facebook.com/samorzad.wita"
            ...
            <a
              href="https://www.instagram.com/team_w4n/"
              className="social-icon-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://discord.com/invite/kEyNeH32"
              className="social-icon-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://pl.linkedin.com/company/samorzad-wita"
              className="social-icon-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.tiktok.com/@samorzad_wita"
              className="social-icon-link"
              target="_blank"
              rel="noopener noreferrer"
            >
